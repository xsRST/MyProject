...
(function ($) {
    ...
    $.fn.combobox = function (_4b, _4c) {
        ...
        return this.each(function () {
            ...
            if (_4e) {
                ...
                _4e = $.data(this, "combobox", {
                    options: $.extend({}, $.fn.combobox.defaults, $.fn.combobox.parseOptions(this), _4b),
                    data: []
                });
            }
            _44(this);
    ...
    $.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
        valueField: "value", textField: "text", groupField: null, groupFormatter: function (_60) {
            return _60;
            ...
            $.ajax({
                type: _66.method, url: _66.url, data: _63, dataType: "json", success: function (_67) {
                    _64(_67);
                }, error: function () {
