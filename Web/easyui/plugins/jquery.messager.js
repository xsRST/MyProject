...
(function ($) {
    ...
    function _5(_6) {
        var _7 = $.extend({}, $.messager.defaults, {
            modal: false,
            shadow: false,
            draggable: false,
            resizable: false,
        ...
        _8.dialog($.extend({}, _7, {
            noheader: (_7.title ? false : true),
            openAnimation: (_7.showType),
            closeAnimation: (_7.showType == "show" ? "hide" : _7.showType),
            openDuration: _7.showSpeed,
            closeDuration: _7.showSpeed,
            onOpen: function () {
    ...
    function _a(_b) {
        ...
        _c.dialog($.extend({}, _b, {
            noheader: (_b.title ? false : true), onClose: function () {
                _4();
                if (_b.onClose) {
    ...
    $.messager = {
        show: function (_11) {
            ...
            var dlg = _a($.extend({}, $.messager.defaults, {
